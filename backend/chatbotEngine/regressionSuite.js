...
test('paired village lookup uses human-like from narrative with natural detail sentence', () => {
  const {
    buildSemanticVerifiedAnswer,
  } = require('./responseNarrativeEngine');
  ...
  const answer =
    buildSemanticVerifiedAnswer({
      ...
      result: {
        ...
        results: [
          {
            Association: 'Calia Gawis Farmers Association Inc.',
            'AMIA Villages': 'Sison',
          },
          {
            Association: 'Brgy. Mangkasuy Binalonan Farmers Association Inc.',
            'AMIA Villages': 'Binalonan',
          },
          {
            Association: 'Anda Mushroom Growers and Organic Farmers Association',
            'AMIA Villages': 'Anda',
          },
          {
            Association: 'San Pedro Mabini Farmers Agriculture Cooperative',
...
test('multi-value categorical list is flattened and deduplicated into a human-like answer', () => {
  const {
    buildSemanticVerifiedAnswer,
  } = require('./responseNarrativeEngine');
  ...
  assert.strictEqual(
    answer,
    'They face Landslide, Soil Erosion, Typhoon, Drought, Flood, erosion, Storm Surge, and Sea level rise.'
  );
});
